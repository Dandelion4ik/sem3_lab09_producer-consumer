...
//проходим по всем вложеностям и смотрим че это за элемент (если картинка сохраняем ссылку на картинку) (если ребенок то идем внутрь) 
#include <gumbo.h>// штука которая делает за меня парсер
